...
def imshow3d_slice(ax, array, myzi=0, value_direction='z', pos=0, norm=None, cmap=None):
    """
    ...
    ax.plot_surface(xi, yi, np.full_like(xi, myzi), rstride=1, cstride=1, facecolors=colors, shade=False)
